...
{ 
	...
	case "${prev}" in
		...
		"sample" | "-sample" | "--sample" | "+sample")
		    COMPREPLY=( $(compgen -W "_name1={_?_|_apples_|_barbara_|_boats_|_bottles_|_butterfly_|_cameraman_|_car_|_cat_|_cliff_|_colorful_|_david_|_dog_|_duck_|_eagle_|_elephant_|_earth_|_flower_|_fruits_|_gmicky_|_gmicky_mahvin_|_gmicky_wilber_|_greece_|_gummy_|_house_|_inside_|_landscape_|_leaf_|_lena_|_leno_|_lion_|_mandrill_|_monalisa_|_monkey_|_parrots_|_pencils_|_peppers_|_roddy_|_rooster_|_rose_|_square_|_teddy_|_tiger_|_tulips_|_wall_|_waterfall_|_zelda_},_name2,...,_nameN,_width={_>=0_|_0_(auto)_},_height_=_{_>=0_|_0_(auto)_} (no_arg)") ); return 0;;
		...
		"deblur_goldmeinel" | "-deblur_goldmeinel" | "--deblur_goldmeinel" | "+deblur_goldmeinel")
		    COMPREPLY=( $(compgen -W "sigma>=0,__nb_iter>=0,__acceleration>=0,__kernel_type={_0=quasi-gaussian_(faster)_|_1=gaussian_}. >") ); return 0;;
		...
		"circles3d" | "-circles3d" | "--circles3d" | "+circles3d")
		    COMPREPLY=( $(compgen -W "_radius>=0,_is_filled={_0_|_1_} >") ); return 0;;
		...
		"elif" | "-elif" | "--elif" | "+elif")
		    COMPREPLY=( $(compgen -W "boolean filename") ); return 0;;
